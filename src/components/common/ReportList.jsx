...
const ReportList = () => {
  ...
  return (
    <motion.div
      ...
      className="w-11/12 md:w-auto md:max-w-5xl mx-auto"
    >
        ...
        <table className="w-full table-auto text-left">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="px-2 md:px-4 py-2 text-[12px] md:text-base gap-2 flex"><span className="hidden md:block">Report</span> Name</th>
